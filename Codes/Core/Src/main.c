...
void WS2812_Send (void)
{
	...
	for (int i= 0; i<MAX_LED; i++)
	{
		...
		color[i] = (data_from_system[k+1]<<16) | (data_from_system[k]<<8) | (data_from_system[k+2]);
...
static void MX_GPIO_Init(void)
{
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, MCU_LEDR_Pin|en_ticket_Pin, GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : MCU_LEDR_Pin en_ticket_Pin */
	GPIO_InitStruct.Pin = MCU_LEDR_Pin|en_ticket_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
	...
	/*Configure GPIO pin : ticket_nuch_Pin */
	GPIO_InitStruct.Pin = ticket_nuch_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	HAL_GPIO_Init(ticket_nuch_GPIO_Port, &GPIO_InitStruct);
